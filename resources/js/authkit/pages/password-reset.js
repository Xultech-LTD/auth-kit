 ...
 * AuthKit
 * -----------------------------------------------------------------------------
 * File: js/pages/password-reset.js
 * Author: Michael Erastus
 * Package: AuthKit
 *
 * Description:
 * -----------------------------------------------------------------------------
 * Password-reset page runtime module for the AuthKit browser client.
 *
 * This file is responsible for discovering and exposing reset-password page
 * DOM references in a schema-safe way without assuming hard-coded field names.
 *
 * Responsibilities:
 * - Confirm the current page matches the password-reset runtime entry.
 * - Resolve the current page root element.
 * - Resolve the primary reset-password form.
 * - Discover rendered controls from the current page form.
 * - Classify context and password controls without assuming fixed schema field names.
...
/**
 * Resolve the primary password-reset form from the current page.
 *
 * Current rule:
 ...
 */
export function getPasswordResetForm(context) {
...
/**
 * Resolve visible non-password reset controls safely.
 *
...
/**
 * Build a normalized password-reset page descriptor.
 *
 * @param {Object|null} context
 * @returns {{
 ...
 * }}
 */
export function getPasswordResetPageElements(context) {
...
/**
 * Boot the password-reset page runtime module.
 *
 * @param {Object} context
 * @returns {Object|null}
 */
export function boot(context) {
    if (!isObject(context) || !isCurrentPage('password_reset')) {
        return null;
    }
