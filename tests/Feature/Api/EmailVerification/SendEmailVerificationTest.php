...
beforeEach(function (): void {
    ...
    Config::set('auth.providers.users', [
        'driver' => 'eloquent',
        'model' => \Xul\AuthKit\Tests\Feature\Api\EmailVerification\SendEmailVerificationTestUser::class,
    ]);
    ...
    Config::set('authkit.route_names.api.send_email_verification', 'authkit.api.email.verification.send');
...
it('returns a standardized action result from send email verification action', function (): void {
    ...
    $result = $action->handle('meritinfos@gmail.com');
