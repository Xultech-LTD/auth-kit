...
use Xul\AuthKit\Http\Requests\App\Confirmations\ConfirmTwoFactorRequest;
 ...
 *
 * Handles authenticated two-factor confirmation submissions used by AuthKit's
 * step-up security flow.
 *
 * Responsibilities:
 * - Validate the incoming request through ConfirmTwoFactorRequest.
 * - Build the normalized mapped payload for the confirm-two-factor context.
 * - Delegate code verification to ConfirmTwoFactorAction.
...
final class ConfirmTwoFactorController
{
    ...
    /**
     * Handle the incoming two-factor confirmation request.
     *
     * @param  ConfirmTwoFactorRequest  $request
     * @param  ConfirmTwoFactorAction  $action
    ...
    public function __invoke(
        ...
        $payload = MappedPayloadBuilder::build('confirm_two_factor', $request->validated());
