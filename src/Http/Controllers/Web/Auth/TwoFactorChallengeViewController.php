...
/**
 * TwoFactorChallengeViewController
 *
 * Renders the two-factor authentication challenge page.
 *
 ...
 */
final class TwoFactorChallengeViewController
{
    /**
    ...
    public function __invoke(Request $request): View|RedirectResponse
    {
        ...
        return view('authkit::auth.two-factor-challenge', [
