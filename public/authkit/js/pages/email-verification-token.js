 ...
 * AuthKit
 * -----------------------------------------------------------------------------
 * File: js/pages/email-verification-token.js
 * Author: Michael Erastus
 * Package: AuthKit
 *
 * Description:
 * -----------------------------------------------------------------------------
 * Email verification token page runtime module for the AuthKit browser client.
 *
 * This file is responsible for discovering and exposing email-verification-
 * token page DOM references in a schema-safe way without assuming hard-coded
 * field names.
 *
 * Responsibilities:
 * - Confirm the current page matches the email verification token runtime entry.
 * - Resolve the current page root element.
 * - Resolve the primary verification form.
 * - Discover rendered controls from the current page form.
 * - Classify verification and hidden context controls without assuming fixed
 *   schema field names.
 ...
 * - This file does not hard-code field names such as "email" or "token".
...
/**
 * Resolve the primary email verification token form from the current page.
 *
 * Current rule:
 ...
 */
export function getEmailVerificationTokenForm(context) {
...
/**
 * Build a normalized email verification token page descriptor.
 *
 * @param {Object|null} context
 * @returns {{
 ...
 * }}
 */
export function getEmailVerificationTokenPageElements(context) {
...
/**
 * Boot the email verification token page runtime module.
 *
 * @param {Object} context
 * @returns {Object|null}
 */
export function boot(context) {
    if (!isObject(context) || !isCurrentPage('email_verification_token')) {
        return null;
    }
